const Navbar = () => {
  return (
    <nav className="sticky top-0 bg-blue-500 text-white px-3 sm:px-6 py-2 sm:py-4 flex flex-wrap sm:flex-nowrap justify-between items-center h-auto sm:h-14 z-10">
